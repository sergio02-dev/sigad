<?php
    ...
    if($fuente_financiacion){
        ...
        for ($lista_fuentes=0; $lista_fuentes < $cantidad_fuentes ; $lista_fuentes++) { 
            ...
            $validacion_saldo_poai = $modificarsolicitudcdp->validacion_saldo_poai($codigo_fuente, $codigo_solicitud);
    ...
    $modificarsolicitudcdp->setAccion($selAccion);
    ...
    $modificarsolicitudcdp->setFuentesFinanciacion($array_fuentes_financiacion);

    if($numero_validacion == 0){
        $modificarsolicitudcdp->updateSolicitud();
    }
    else{
