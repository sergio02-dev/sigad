<?php
    ...
    include('prcsos/cdp/mdfcarCdp.php');
    ...
    if($etapass){
        ...
        for ($array_etapa=0; $array_etapa < $cantidad; $array_etapa++) { 
            ...
            $dtEtpa = $modificarCdp->data_etapa($codigo_etapa);
    ...
    $modificarCdp->setFecha($txtFechaExpedicion);
    $modificarCdp->setNumero($txtNumeroExpedicion);
    $modificarCdp->setCodigoSolicitud($codigo_solicitud);
    $modificarCdp->setPersonaSistema($personaSistema);
    $modificarCdp->setCodigo($codigo_cdp);
    $modificarCdp->setArrayDatos($array_datos);

    echo $modificarCdp->mdfcar_cdp();
?>