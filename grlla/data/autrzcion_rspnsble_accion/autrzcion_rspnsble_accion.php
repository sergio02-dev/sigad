...
<table id="tableAutorizacionResponsableAccion" class="table table-striped table-bordered table-sm">

</table>

<script>
    $(document).ready(function() {
        var table =	$('#tableAutorizacionResponsableAccion').DataTable({
            "processing": true,
            "language": {
            ...
            ajax: {
                url: 'jautorizacionresponsableaccion',
                type: 'POST'
            },
            columns: [
                ...
                { data: 'nombre_fuente', title: 'FUENTES'},
                {
                    ...
                    render: function (data, type, full, meta){
                        return '<div class="d-inline-block"><i class="fas fa-check fa-lg color_icono" title="Autorización Responsable Acción" style="display:<?php echo $visibilidad; ?>;" onclick="autorizacion(\''+full["scdp_codigo"]+'\');"></i></div>';
                    }
                },
                /*{
        ...
        $('#tableAutorizacionResponsableAccion tbody').on('click', 'td.details-control', function(){
    ...
    function autorizacion(codigo_solicitud){
        ...
        $.ajax({
            url:"frmautorizacionresponsableaccion",
            type:"POST",
