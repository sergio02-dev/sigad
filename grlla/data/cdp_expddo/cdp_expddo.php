...
<table id="tableCdpExpedido" class="table table-striped table-bordered table-sm">

</table>

<script>
    $(document).ready(function() {
        var table =	$('#tableCdpExpedido').DataTable({
            "processing": true,
            "language": {
            ...
            columns: [
                ...
                { data: 'numero_expedicion', title: 'NÚMERO CDP'},
                ...
                { data: 'nombre_fuente', title: 'FUENTES'},
                {
                    ...
                    render: function (data, type, full, meta){
                        if(full['editar'] == 1){
                            return '<div class="d-inline-block"><i class="fas fa-file-signature fa-lg color_icono" title="Expedir Solicitud" style="display:<?php echo $visibilidad; ?>;" onclick="mod_expedicion_cdp(\''+full["codigo_solicitud"]+'\', \''+full["codigo_cdp"]+'\');"></i></div> &nbsp;&nbsp; ';
                        }
                        else{
        ...
        $('#tableCdpExpedido tbody').on('click', 'td.details-control', function(){
    ...
    function mod_expedicion_cdp(codigo_solicitud, codigo_cdp){
        ...
        $.ajax({
            url:"formcdp",
            type:"POST",
            data:"codigo_solicitud="+codigo_solicitud+'&codigo_cdp='+codigo_cdp,
            async:true,
