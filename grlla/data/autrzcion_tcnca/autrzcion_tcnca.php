...
<table id="tableAutorizacionTecnica" class="table table-striped table-bordered table-sm">

</table>

<script>
    $(document).ready(function() {
        var table =	$('#tableAutorizacionTecnica').DataTable({
            "processing": true,
            "language": {
            ...
            ajax: {
                url: 'jautorizaciontecnicasolicitud',
                type: 'POST'
            },
            columns: [
                ...
                { data: 'nombre_fuente', title: 'FUENTES'},
                {
                    ...
                    render: function (data, type, full, meta){
                        return '<div class="d-inline-block"><i class="fas fa-check fa-lg color_icono" title="Autorización Técnica" style="display:<?php echo $visibilidad; ?>;" onclick="autorizacion(\''+full["scdp_codigo"]+'\');"></i></div>';
                    }
                },
                /*{
        ...
        $('#tableAutorizacionTecnica tbody').on('click', 'td.details-control', function(){
    ...
    function autorizacion(codigo_solicitud){
        ...
        $.ajax({
            url:"frmautorizaciontecnicasolicitud",
            type:"POST",
