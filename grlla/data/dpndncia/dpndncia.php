...
<script>
            ...
            columns: [
                ...
                { data: 'estado', title: 'Estado'},
                {
                    ...
                    render: function (data, type, full, meta){
                        return '<div class="d-inline-block"> <i class="fas fa-edit fa-lg color_icono" title="Editar PPI" style="display:<?php echo $visibilidad; ?>;" onclick="editarDependencia(\''+full["ofi_codigo"]+'\');"></i> </div> ';
                    },
                    title: 'Editar'
                },	
    ...
    function editarDependencia(codigo_dependencia){
        var codigo_dependencia = codigo_dependencia;
        ...
        $.ajax({
            url:"formdependencia",
            type:"POST",
            data:"codigo_dependencia="+codigo_dependencia,
            async:true,
