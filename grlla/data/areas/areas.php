            ...
            columns: [
                ...
                { data: 'estado', title: 'Estado'},
                {
                    ...
                    render: function (data, type, full, meta){
                        return '<div class="d-inline-block"> <i class="fas fa-edit fa-lg color_icono" title="Editar PPI" style="display:<?php echo $visibilidad; ?>;" onclick="editarAreas(\''+full["are_codigo"]+'\');"></i> </div> ';
                    },
                    title: 'Editar'
                },	
