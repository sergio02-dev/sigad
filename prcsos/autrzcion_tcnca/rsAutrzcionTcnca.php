 ...
 * Rs Autorizacion Tecnica Solicitud CDP
 */
include('classAutrzcionTcnca.php');
class RsAutrzcionTcnca extends AutorizacionTecnica{
    private $cnxion;
    ...
    public function autorizacion_tecnica($codigo_solicitud){

        $sql_autorizacion_tecnica="SELECT COUNT(*) AS aprovacion_tecnica
                                     FROM cdp.aprovacion_solicitud
                                    WHERE asol_clasificacion = 1 
                                      AND asol_solicitud = $codigo_solicitud;";

        $query_autorizacion_tecnica=$this->cnxion->ejecutar($sql_autorizacion_tecnica);

        $data_autorizacion_tecnica=$this->cnxion->obtener_filas($query_autorizacion_tecnica);

        $aprovacion_tecnica = $data_autorizacion_tecnica['aprovacion_tecnica'];
            ...
            foreach ($rs_solicitudes as $dta_solicitud) {
                ...
                if($autorizacion_tecnica == 0){
                    ...
                    $rsRslciones[] = array('scdp_codigo'=> $scdp_codigo, 
                                            ...
                                            'autorizacion_tecnica'=> $autorizacion_tecnica
                                        );
                }
            }
            if($rsRslciones){
