<?php
    ...
    class RsRp extends Rp{
        ...
        public function codigo_rp($rp_codigo){

            $sql_codigo_rp="SELECT rp_codigo, rp_cdp, rp_fecha
                              FROM cdp.rp
                             WHERE rp_cdp = $rp_codigo;";
        ...
        public function form_rp($codigo_rp){
    
            $sql_form_rp="SELECT rp_codigo, rp_cdp, rp_fecha, 
                                 rp_numerorp, rp_otrovalor, 
                                 rp_valor, rp_proveedor,
                                 rp_actoadmin, rp_servicio
                            FROM cdp.rp
                           WHERE rp_codigo = $codigo_rp;";
                                        
            $query_form_rp=$this->cnxion->ejecutar($sql_form_rp);
    
            while($data_form_rp=$this->cnxion->obtener_filas($query_form_rp)){
                $dataform_rp[]=$data_form_rp;
            }
            return $dataform_rp;
        }

        public function valor_total_cdp($codigo_cdp){
    
            $sql_valor_total_cdp="SELECT SUM(aso_valor) AS valor
                                    FROM cdp.cdp
            ...
            $query_valor_total_cdp=$this->cnxion->ejecutar($sql_valor_total_cdp);
    
            $data_valor_total_cdp=$this->cnxion->obtener_filas($query_valor_total_cdp);
    
            $valor = $data_valor_total_cdp['valor'];
