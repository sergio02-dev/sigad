<?php
include('prcsos/formfun/classFormfun.php');
Class RsMdfcarPlanComprasFun extends Funcionamiento{
    ...
    public function form_plancomprasfun($codigo_fun){
        
            $sql_form_plancomprasfun = "SELECT  fun_sede, 
                                                fun_vicerrectoria, fun_facultad, 
                                                fun_dependencia, fun_area, 
                                                fun_linea, fun_sublinea, 
                                                fun_equipo, fun_equipodescripcion, 
                                                fun_valorunitario, fun_cantidad, fun_estado,
                                                fun_valorunitario * fun_cantidad AS total
                                                FROM usco.funcionamiento
                                                WHERE fun_codigo = $codigo_fun;";
            

        $resultado_form_plancomprasfun = $this->cnxion->ejecutar($sql_form_plancomprasfun);

        ($data_form_plancomprasfun = $this->cnxion->obtener_filas($resultado_form_plancomprasfun));
        $dataform_plancomprasfun[] = $data_form_plancomprasfun;
        return $dataform_plancomprasfun;
    }
