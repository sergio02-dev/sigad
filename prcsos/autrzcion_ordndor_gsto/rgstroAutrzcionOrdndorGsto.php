<?php
    ...
    class RgstroAutrzcionOrdndorGsto extends AutorizacionOrdenadorGasto{

        private $codigo_autorizacionordenadorgasto;
        private $cnxion;

        public function __construct(){
            $this->cnxion = Dtbs::getInstance();
            $this->codigo_autorizacionordenadorgasto = date('YmdHis').rand(99,999);
        }
        ...
        public function insert_autorizacion_financiera(){
            ...
            $sql_insert_autorizacion_financiera="INSERT INTO cdp.aprovacion_solicitud(
                                                     ...
                                                     VALUES (".$this->codigo_autorizacionordenadorgasto.", 
                                                             ".$this->getSolicitud().", 
                                                             4, 
                                                             1, 
                                                             NOW(), 
                ...
                foreach ($array_datos as $dta_array_dtos) {
                    ...
                    $sql_aprobacion = "INSERT INTO cdp.aprovacion_solicitud_clasificador(
                                           ...
                                           VALUES ($codigo_autorizacion_clasificador,
                                                   ".$this->codigo_autorizacionordenadorgasto.", 
                                                   $codigo_actividad, 
                                                   $codigo_etapa, 
                                                   $codigo_clasificador, 
                                                   $codigo_aprobacion, 
