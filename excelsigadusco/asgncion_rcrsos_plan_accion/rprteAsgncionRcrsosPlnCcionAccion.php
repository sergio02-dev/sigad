...
$nombreNivelTres = $objRprtePlnAccion->nombreNivelTres($codigo_plandesarrollo);

$sigla_nivel_tres = $objRprtePlnAccion->sigla_nivel_tres($accion_cod);

$nombre_rprte = "AsignacionRecursosPlanAccion_".$nombreNivelTres."_".$sigla_nivel_tres."_";
