...
$nombreNivelDos = $objRprtePlnAccion->nombreNivelDos($codigo_plandesarrollo);

$sigla_nivel_dos = $objRprtePlnAccion->sigla_nivel_dos($proyecto_cod);

$nombre_rprte = "AsignacionRecursosPlanAccion_".$nombreNivelDos."_".$sigla_nivel_dos."_";
