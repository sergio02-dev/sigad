...
$Subsistemas=$objRprte->subSistemasPlanDesarrollo($codigo_plandesarrollo);
...
if($Subsistemas){//If Subsistema
  foreach ($Subsistemas as $data_subsistema) {//Forech Subsistema
    ...
    $list_proyecto = $objRprte->proyecto_subsistema($sub_codigo);
    ...
    if($list_proyecto){
      foreach ($list_proyecto as $dta_list_proyecto){
        ...
        $accion_proyecto = $objRprte->accion_proyecto($pro_codigo);
        ...
        if($accion_proyecto){
          foreach ($accion_proyecto as $dta_accion_proyecto) {
            ...
            $actividadPoai=$objRprte->actividadPoai($acc_codigo, $vigencia);
            if($actividadPoai){
