...
if($Subsistemas){//If Subsistema
    foreach ($Subsistemas as $data_subsistema) {//Forech Subsistema
                    ...
                    foreach ($accion_proyecto as $dta_accion_proyecto) {
                        ...
                        if($actividadPoai){
                            foreach($actividadPoai as $data_actividadPoai){
                                ...
                                $datos_indicador = $objRprte->datos_indicador($acp_sedeindicador);
                                if($datos_indicador){
                                ...
                                $objPHPExcel->getActiveSheet($numero_registro)->getStyle('I'.$num_registroActividad)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_CURRENCY_USD);
                                ...
                                if($etapas){
                                    ...
                                    $sumaRecurso = $objRprte->sumaRecursoEtapas($acp_codigo);

                                    $rs_avanceEsperado = $objRprte->avanceEsperado($acp_codigo);
        ...
        $objPHPExcel->getActiveSheet($numero_excel)->getColumnDimension('B')->setWidth(38);
        ...
        $objPHPExcel->getActiveSheet($numero_excel)->getColumnDimension('E')->setWidth(35);
        $objPHPExcel->getActiveSheet($numero_excel)->getColumnDimension('F')->setWidth(13);
        $objPHPExcel->getActiveSheet($numero_excel)->getColumnDimension('G')->setWidth(40);
        $objPHPExcel->getActiveSheet($numero_excel)->getColumnDimension('H')->setWidth(18);
        ...
        $objPHPExcel->getActiveSheet($numero_excel)->getColumnDimension('K')->setWidth(30);
        $objPHPExcel->getActiveSheet($numero_excel)->getColumnDimension('L')->setWidth(80);
        $objPHPExcel->getActiveSheet($numero_excel)->getColumnDimension('M')->setWidth(35);
        $objPHPExcel->getActiveSheet($numero_excel)->getColumnDimension('N')->setWidth(65);
        $objPHPExcel->getActiveSheet($numero_excel)->getColumnDimension('O')->setWidth(28);
