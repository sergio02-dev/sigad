...
$nombreNivelUno=$objRprtePlnDsrrllo->nivelUnoNombre();
...
$sigla_nivel_uno = $objRprtePlnDsrrllo->sigla_nivel_uno($sub_sistema);

$nmbre_documento = $nombre_documento."_".$nombreNivelUno."_".$sigla_nivel_uno;

$objPHPExcel->getActiveSheet()->setTitle('Plan Desarrollo');
