...
if($Subsistemas){//If Subsistema
    foreach ($Subsistemas as $data_subsistema) {//Forech Subsistema
        ...
        $proyecto_subsistema = $reportepoaietapa->proyecto_subsistema_x_codigo($sub_codigo, $proyecto_cod);
        if($proyecto_subsistema){
            foreach ($proyecto_subsistema as $dat_prycto_sbstema) {
                ...
                $accion_proyecto = $reportepoaietapa->accion_proyect_x_codigo($pro_codigo, $accion_cod);
                if($accion_proyecto){
