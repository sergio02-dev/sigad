...
if($list_proyecto){
    foreach ($list_proyecto as $dat_lsta_prycto) {
        ...
        if($codigo_plan == 1){
            $descripcion_proyecto = $sigla_nivel_uno.".".$pro_referencia." ".$pro_descripcion;
            $nombre_archvo = $nombre_nivel_dos."_".$sigla_nivel_uno.".".$pro_referencia."_".$fecha_generar;
        }
        else{
            $descripcion_proyecto = $pro_referencia.".".$pro_numero." ".$pro_descripcion;
            $nombre_archvo = $nombre_nivel_dos."_".$pro_referencia.".".$pro_numero."_".$fecha_generar;
        }
