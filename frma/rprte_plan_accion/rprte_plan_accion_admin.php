    ...
    <div class="modal-body">
        ...
        <div class="row todo" style="display: block;">
            <div class="col-md-12">
                ...
                <div class="d-inline-block"><button type="button" class="btn btn-danger btn-sm" onclick="generarCompleto('<?php echo $plan_desarrollo; ?>');"> <i class="fas fa-file-excel fa-lg" >&nbsp; Plan de Acci&oacute;n Completo</i> </button></div> 
            </div>
        </div>
        ...
        <div class="row subsistema" style="display: none;">
            ...
            <div class="col-md-6">
                <br>
                <div class="d-inline-block"> <button type="button" class="btn btn-danger btn-sm" onclick="gnerarExcelSubSistema('<?php echo $plan_desarrollo; ?>');"><i class="fas fa-file-excel fa-lg">&nbsp; Plan de Acci&oacute;n Por <?php echo $nombreNivelUno; ?></i> </button> </div> 
            </div>
        </div>
        ...
        <div class="row proyecto_excel" style="display: none;">
            <div class="col-sm-12">
                <div class="d-inline-block"> <button type="button" class="btn btn-danger btn-sm" onclick="gnerarExcelProyecto('<?php echo $plan_desarrollo; ?>');"><i class="fas fa-file-excel fa-lg" >&nbsp; Plan de Acci&oacute;n Por <?php echo $nombreNivelDos; ?></i> </button></div> 
            </div>
        </div>
        ...
        <div class="row accion_excel" style="display: none;">
            <div class="col-sm-12">
                <br>
                <div class="d-inline-block"> <button type="button" class="btn btn-danger btn-sm" onclick="gnerarExcelAccion('<?php echo $plan_desarrollo; ?>');"><i class="fas fa-file-excel fa-lg" >&nbsp; Plan de Acci&oacute;n Por <?php echo $nombreNivelTres; ?></i> </button></div> 
            </div>
        </div>
        ...
        <div class="row actividad_excel" style="display: none;">
            <div class="col-sm-12">
                <br>
                <div class="d-inline-block"> <button type="button" class="btn btn-danger btn-sm" onclick="gnerarExcelActividad('<?php echo $plan_desarrollo; ?>');"><i class="fas fa-file-excel fa-lg" >&nbsp; Plan de Acci&oacute;n Por Actividad</i> </button></div> 
            </div>
        </div>
        <!-- ******************** FIN FORMULARIO ************************* -->
...
<script type="text/javascript">
    ...
    function generarCompleto(codigo_plandesarrollo){
		...
		window.location.href = 'excelplanaccion?codigo_plandesarrollo='+codigo_plandesarrollo+'&vigencia='+vigencia;        
    }
    ...
    function gnerarExcelSubSistema(codigo_plandesarrollo){
        ...
        window.location.href = 'reporteplanaccionxsubsistema?codigo_plandesarrollo='+codigo_plandesarrollo+'&vigencia='+vigencia+'&sub_sistema='+selSubSistema;        
    ...
    function gnerarExcelProyecto(codigo_plandesarrollo){
        ...
        window.location.href = 'reporteplanaccionxproyecto?codigo_plandesarrollo='+codigo_plandesarrollo+'&vigencia='+vigencia+'&sub_sistema='+selNivelUno+'&proyecto_cod='+selNivelDos;                
    }
    ...
    function gnerarExcelAccion(codigo_plandesarrollo){
        ...
        window.location.href = 'reporteplanaccionxaccion?codigo_plandesarrollo='+codigo_plandesarrollo+'&vigencia='+vigencia+'&sub_sistema='+selNivelUno+'&proyecto_cod='+selNivelDos+'&accion_cod='+selNivelTres;                
    }
    ...
    function gnerarExcelActividad(codigo_plandesarrollo){
        ...
        window.location.href = 'reporteplanaccionxactividad?codigo_plandesarrollo='+codigo_plandesarrollo+'&vigencia='+vigencia+'&sub_sistema='+selNivelUno+'&proyecto_cod='+selNivelDos+'&accion_cod='+selNivelTres+'&actividad_cod='+selActividad;                
    }
