<?php
    ...
    $url_direccion = "dataindicador?codigo_planDesarrollo=".$codigo_plan."&codigo_accion=".$codigo_accion;
?>
<form id="responsableindicadorform" role="form">
    <div class="modal-header fondo-titulo">
        <h4 class="modal-title"><strong><?php echo $task; ?> ENCARGADO - <?php echo strtoupper(tildes($nombre_form)); ?></strong></h4>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-danger" onClick="validar_responsable_indicador();"><i class="far fa-save"></i> Guardar</button>
    </div>
</form>

<script src="js/jquery.validate.min.js"></script>
<script src="vjs/vldar_rspnsble_indcdor.js"></script>
