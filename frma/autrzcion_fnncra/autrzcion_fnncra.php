<?php
    ...
    $datos_solicitud = $objAutorizacionFinanciera->datos_solicitud($codigo_solicitud);
    if($datos_solicitud){
        ...
        $descripcion_accion = $objAutorizacionFinanciera->descripcion_accion($scdp_accion);
    }
    $tarea = "AUTORIZACI&Oacute;N FINANCIERA SOLICITUD N° ".$numero_solicitudCDP;
    $url_proceso = "registroautorizacionfinanciera";

?>
<form id="autorizacionFinancieraForm" role="form">
    ...
    <div class="modal-body">
        ...
        <?php 
            $actividades_solicitud = $objAutorizacionFinanciera->actividades_solicitud($codigo_solicitud);
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-sm table-striped table-bordered">
                    ...
                    <tbody>
                        <?php 
                            $etapa_solicitud = $objAutorizacionFinanciera->etapa_solicitud($codigo_solicitud, $aes_actividad);
                            if($etapa_solicitud){
                        ...
                        <?php 
                            $clasificador_etapa = $objAutorizacionFinanciera->clasificador_etapa($codigo_solicitud, $aes_etapa);
                                    if($clasificador_etapa){
                                        foreach ($clasificador_etapa as $dta_clsfcdres) {
                                            ...
                                            list($nombre, $numero) = $objAutorizacionFinanciera->nmbre_clsfcdor($esc_clasificador);
...
<script src="vjs/autrzcion_fnncra/vldar_autrzcion_fnncra.js" type="text/javascript"></script>