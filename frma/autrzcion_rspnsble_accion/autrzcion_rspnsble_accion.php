<?php
    ...
    $datos_solicitud = $objAutorizacionResponsableAccion->datos_solicitud($codigo_solicitud);
    if($datos_solicitud){
        ...
        $descripcion_accion = $objAutorizacionResponsableAccion->descripcion_accion($scdp_accion);
    }
    $tarea = "AUTORIZACI&Oacute;N RESPONSABLE ACCI&Oacute;N, SOLICITUD N° ".$numero_solicitudCDP;
    $url_proceso = "registroautorizacionresponsableaccion";

?>
<form id="autorizacionRspnsbleAccionForm" role="form">
    ...
    <div class="modal-body">
        ...
        <?php 
            $actividades_solicitud = $objAutorizacionResponsableAccion->actividades_solicitud($codigo_solicitud, $scdp_accion);
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-sm table-striped table-bordered">
                    ...
                    <tbody>
                        <?php 
                            $etapa_solicitud = $objAutorizacionResponsableAccion->etapa_solicitud($codigo_solicitud, $aes_actividad, $scdp_accion);
                            if($etapa_solicitud){
                        ...
                        <?php 
                            $clasificador_etapa = $objAutorizacionResponsableAccion->clasificador_etapa($codigo_solicitud, $aes_etapa, $scdp_accion);
...
<script src="vjs/autrzcion_rspnsble_accion/vldar_autrzcion_rspnsble_accion.js" type="text/javascript"></script>