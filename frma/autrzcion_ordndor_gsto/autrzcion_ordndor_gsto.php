<?php
    ...
    $datos_solicitud = $objAutorizacionOrdenadorGasto->datos_solicitud($codigo_solicitud);
    if($datos_solicitud){
        ...
        $descripcion_accion = $objAutorizacionOrdenadorGasto->descripcion_accion($scdp_accion);
    }
    $tarea = "AUTORIZACI&Oacute;N ORDENADOR DEL GASTO, SOLICITUD N° ".$numero_solicitudCDP;
    $url_proceso = "registroautorizacionordenadorgasto";

?>
<form id="autorizacionOrdenadorGastoForm" role="form">
    ...
    <div class="modal-body">
        ...
        <?php 
            $actividades_solicitud = $objAutorizacionOrdenadorGasto->actividades_solicitud($codigo_solicitud);
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-sm table-striped table-bordered">
                    ...
                    <tbody>
                        <?php 
                            $etapa_solicitud = $objAutorizacionOrdenadorGasto->etapa_solicitud($codigo_solicitud, $aes_actividad);
                            if($etapa_solicitud){
                        ...
                        <?php 
                            $clasificador_etapa = $objAutorizacionOrdenadorGasto->clasificador_etapa($codigo_solicitud, $aes_etapa);
                                    if($clasificador_etapa){
                                        foreach ($clasificador_etapa as $dta_clsfcdres) {
                                            ...
                                            //list($nombre, $numero) = $objAutorizacionOrdenadorGasto->nmbre_clsfcdor($esc_clasificador);
...
<script src="vjs/autrzcion_ordndor_gsto/vldar_autrzcion_ordndor_gsto.js" type="text/javascript"></script>