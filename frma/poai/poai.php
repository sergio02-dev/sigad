<?php
    ...
    if($codigo_poai){
        ...
        foreach ($form_poai as $dat_form_poai) {
            ...
            $poav_adicion = $dat_form_poai['poav_adicion'];
            $poav_acuerdo = $dat_form_poai['poav_acuerdo'];
        }
        ...
        <div class="row">
            <div class="col-sm-2">
                <div class="form-group"><br>
                    <input id="adicionPoai" class="checkAdicion" name="adicionPoai" type="checkbox" value="1" <?php echo $check_adicion; ?>>
                    <label for="txtEstado" class="font-weight-bold">&nbsp;Adici&oacute;n *</label>
                </div>
            </div>
            <div class="col-sm-7 actoPoai" style="display: <?php echo $acto_poai ?>">
                <div class="form-group">
                    <label for="selAcuerdo" class="font-weight-bold">Acto Administrativo *</label>
                    <select name="selAcuerdo" id="selAcuerdo"  class="form-control caja_texto_sizer selectpickerindicador" data-size="8" data-rule-required="true" required>
                    <option value="0" data-tipo_fuente="0"> Seleccione ...</option>
                        <?php
                            ...
                            if($list_acuerdo){
                                foreach ($list_acuerdo as $dat_acuerdo) {
                                    ...
                                    if($caracteres > 60){
                                        $descripcion = substr($add_nombre,0,80)."...";
                                    }
                                    else{
                                        $descripcion = $add_nombre;
                                    }

                                    if($poav_acuerdo == $aad_codigo){
